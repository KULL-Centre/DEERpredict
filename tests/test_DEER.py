...
def test_HIV1PR_PDBs():
    ...
    for pdb in ['3bvb','2bpx','1hhp','1tw7']:
        ...
        DEER = DEERpredict(u, residues = [55,55], libname = 'MTSSL 175K X1X2', chains=['A', 'B'], rmax=7.5)
...
def test_HIV1PR_SIMs():
    for sim in ['unbiased','rdc']:
        ...
        DEER = DEERpredict(u, residues = [55,55], libname = 'MTSSL 175K X1X2', chains=['A', 'B'], z_cutoff = 0.05, rmax=7.5)
...
def test_T4L():
    for pdb in ['3dmv','2lcb','2lc9']:
        ...
        for residues in [[89, 109],[109, 140]]:
            DEER = DEERpredict(u, residues = residues, libname = 'MTSSL 175K X1X2', temperature = 298, z_cutoff = 0.05, rmax = 7.5)
