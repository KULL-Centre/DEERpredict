...
def calcIratio(path,tau_c,args):
    ...
    PRE = PREpredict(u, label, libname = 'MTSSL 175K X1X2', log_file = path+'/log',
...
def test_NANODISC():
    ...
    for label in labels:
        PRE = PREpredict(u, residue = label, libname = 'MTSSL 175K X1X2', chains = ['A','B'], temperature = 303.15, atom_selection = 'N')
